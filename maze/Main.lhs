...
> drawEW (Maze (x,_) walls) x y1 = ["|"]
> drawEW (Maze (x,y) walls) pos_x y1 = if hasWall (Maze (x,y) walls) ((pos_x,y1), E) then "|  ":(drawEW (Maze (x,y) walls) (pos_x + 1) y1) else (drawEW (Maze (x,y) walls) (pos_x + 1) y1)

> drawMaze :: Maze -> String
> drawMaze (Maze (x,y) walls) = ""
